                                ...
                                if (broadcast) {
                                        ...
                                        if (!color.has(user.userid)) {
                                                ...
                                                if (user.getIdentity(room.id).substring(0, 1) !== ' ') {
                                                        if (room.battle) room.add('|html|<button class="userbuttonbattle" name="parseCommand" value="/user ' + user.getIdentity() + '"><font color = "gray">' + user.getIdentity().substr(0, 1) + '</font><b><font color = ' + color.get(user.userid) + '>' + user.name + ': </font></b></button> ' + (formatMessage(suppressMessage) || formatMessage(message)));
                                                        else room.add('|html|<button class="userbutton" name="parseCommand" value="/user ' + user.getIdentity() + '"><font color = "gray">' + user.getIdentity().substr(0, 1) + '</font><b><font color = ' + color.get(user.userid) + '>' + user.name + ': </font></b></button> ' + (formatMessage(suppressMessage) || formatMessage(message)));
                                                } else {
                                                        if (room.battle) room.add('|html|<button class="userbutton" name="parseCommand" value="/user ' + user.getIdentity() + '"><b><font color = ' + color.get(user.userid) + '>' + user.name + ': </font></b></button> ' + (formatMessage(suppressMessage) || formatMessage(message)));
                                                        else room.add('|html|<button class="userbutton" name="parseCommand" value="/user ' + user.getIdentity() + '"><b><font color = ' + color.get(user.userid) + '>' + user.name + ': </font></b></button> ' + (formatMessage(suppressMessage) || formatMessage(message)));
                                                }
                                        }
